...
import { MessageSquare, X, Monitor, Smartphone, Info, PanelRight } from "lucide-react"
...
{/* 
      ...
      <Sidebar side="right" variant="sidebar" className="border-l-0! p-4 pt-20 pointer-events-none"
